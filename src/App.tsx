...
import NeoraDesignerOS from "./components/designer-os/NeoraDesignerOS";
import { AIDevelopmentStudio } from "./components/AIDevelopmentStudio";
              ...
              >
                {(
                  [
                    ...
                    {
                      id: "aiDevStudio",
                      label: lang === "bn" ? "এআই ডেভ স্টুডিও" : "AI Dev Studio",
                      icon: Cpu,
                      color: "#a855f7",
                    },
                    {
              ...
              >
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {activeTab === "aiDevStudio" && <AIDevelopmentStudio lang={lang} />}
                  </motion.div>
                </AnimatePresence>
              </main>
            )}
