  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#030305] text-white">
      ...
      <div className="relative z-10 flex min-h-screen">
        <aside className="hidden md:flex w-72 flex-col border-r border-cyan-500/10 bg-slate-950/60 backdrop-blur-xl">
        ...
        <main className="flex-1 pb-24 md:pb-5">
          <div className="sticky top-0 z-20 border-b border-white/5 bg-slate-950/60 px-4 py-3 backdrop-blur-xl md:hidden">
          ...
          {children}
          <nav className="fixed inset-x-3 bottom-3 z-30 grid grid-cols-6 gap-2 rounded-2xl border border-white/8 bg-slate-950/80 p-2 backdrop-blur-xl md:hidden">
            {navItems.map((item) => (
              <button
                key={item.id}
                type="button"
